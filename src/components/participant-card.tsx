  ...
  return (
    ...
    >
      ...
      {entry.missingFile ? (
        ...
        <>
          <div className="mt-6 hidden overflow-x-auto rounded-2xl border border-white/5 md:block">
          ...
          <p className="mt-3 text-xs text-white/40 md:hidden">Tap a card for the full pick details, or rotate your phone for the grid view.</p>
        </>
      )}
    </div>
  );
